...
public class CompoundKeyProviderTest {
  ...
  public void suppliesCompoundKey() {
    var compoundKeyProvider = new SampleCompoundKeyProvider("Hello", "world!", true);
    assertThat(compoundKeyProvider.toCompoundKey().toString()).isEqualTo("5:Hello-6:world!-4:true");
  }
